describe('TC-PBI20.3-1-3-VALIDATE-USER-EMAIL\n Senario : create an user: invalid email' , () => {
    ...
    it("should have a validation message: [Email] Please enter a part followed by '@'.",()=>{
        ...
        cy.get('.ann-email').type('@kmutt.ac.th')
        ...
        cy.get('.ann-email').then(($input)=>{
            expect($input[0].validationMessage).to.contains("Please enter a part followed by '@'.")
        })
    })
});