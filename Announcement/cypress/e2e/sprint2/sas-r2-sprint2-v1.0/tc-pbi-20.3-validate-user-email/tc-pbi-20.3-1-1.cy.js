describe('TC-PBI20.3-1-1-VALIDATE-USER-EMAIL\n Senario : create an user: invalid email' , () => {
    ...
    it("should have a validation message: [Email] Please include an '@' in the email address.",()=>{
        ...
        cy.get('.ann-email').then(($input)=>{
            expect($input[0].validationMessage).to.contains("Please include an '@' in the email address.")
        })
    })
});