describe('TC-PBI23-1-7-INCLUDE-PASSWORD\n Senario : create an user: password is Sasownerint222#' , () => {
    ...
    it('should open add form, type user data and submit the form',()=>{
        ...
        cy.get('.ann-password').type('Sasownerint222#').should('have.value','Sasownerint222')
        cy.get('.ann-confirm-password').type('Sasownerint222#').should('have.value','Sasownerint222')
